...
public class MsgTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------
    ...
    private static final MsgTypeSupport _singleton
    = new MsgTypeSupport();
    ...
    */
    public static MsgTypeSupport get_instance() {
        return _singleton;
    }

    public static MsgTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MsgTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Msg</code>
    * type.
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((MSG_LEN.VALUE))+1);
        currentAlignment +=CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((MSG_LEN.VALUE))+1);
        if (include_encapsulation) {
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.sender );

        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.message );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.sender,(MSG_LEN.VALUE));

            dst.writeString(typedSrc.message,(MSG_LEN.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.sender = src.readString((MSG_LEN.VALUE));
                typedDst.message = src.readString((MSG_LEN.VALUE));
    ...
    int mask) {
        return new MsgDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MsgDataReader(native_reader, listener, mask, this);   
    ...
    protected MsgTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MsgTypeCode.VALUE,Msg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MsgTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MsgTypeCode.VALUE,Msg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
